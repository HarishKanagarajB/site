...
export default async function CaseStudys() {
  let data = [];
          ...
          {data.map((data: any) => (
            ...
            >
              <Link
                ...
                style={{
                  backgroundImage: "url('./images/icons/plug-white-64.png')",
              ...
              <ul className="flex justify-center">
                <li className="inline-block text-sm text-gray-500 font-light">
                  {data?.acf?.technology && data.acf.technology.length > 0 ? (
                    <div className="technology-list">
                      {data.acf.technology.map((tech: any, index: any) => (
                        <span
                          key={index}
                          className={`technology-item ${
                            index !== data.acf.technology.length - 1 ? "mr-2" : ""
                          }`}
                        >
                          {tech}
                        </span>
